...
function plan(params) {
    try {
        ...
        const chained = params.rootConstraints.isMultiple
...
function buildPlanServiceNodeFromClassElementMetadata(params, bindingConstraintsList, elementMetadata) {
    ...
    if (elementMetadata.kind === ClassElementMetadataKind_1.ClassElementMetadataKind.singleInjection) {
        (0, checkServiceNodeSingleInjectionBindings_1.checkServiceNodeSingleInjectionBindings)(serviceNode, elementMetadata.optional, bindingConstraints, { chained });
        const [planBindingNode] = serviceNodeBindings;
        serviceNode.bindings = planBindingNode;
    }
    return serviceNode;
...
function buildPlanServiceNodeFromResolvedValueElementMetadata(params, bindingConstraintsList, elementMetadata) {
    ...
    const bindingConstraints = new BindingConstraintsImplementation_1.BindingConstraintsImplementation(updatedBindingConstraintsList.last);
    const chained = elementMetadata.kind === ResolvedValueElementMetadataKind_1.ResolvedValueElementMetadataKind.multipleInjection
        ? elementMetadata.chained
        : false;
    const filteredServiceBindings = (0, buildFilteredServiceBindings_1.buildFilteredServiceBindings)(params, bindingConstraints, {
        chained,
...
function buildServiceNodeBindings(params, bindingConstraintsList, serviceBindings, parentNode, chainedBindings) {
    ...
    for (const binding of serviceBindings) {
        switch (binding.type) {
            ...
            case BindingType_1.bindingTypeValues.ServiceRedirection: {
                const planBindingNode = buildServiceRedirectionPlanBindingNode(params, bindingConstraintsList, binding, parentNode, chainedBindings);
...
function buildServiceRedirectionPlanBindingNode(params, bindingConstraintsList, binding, parentNode, chainedBindings) {
    const childNode = {
        binding,
        parent: parentNode,
        redirections: [],
